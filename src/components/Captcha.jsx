    ...
    return (
        <div className="flex justify-center items-center gap-4 flex-col text-center">
            <div className="w-56 h-10 text-center relative">
                ...
                <p className="text-black absolute w-56 h-10 z-20 text-2xl select-none">{string}</p>
                <div className="z-30 bg-blue-100 absolute opacity-20 w-56 h-10 select-none">{string2}{string2}</div>
            </div>
